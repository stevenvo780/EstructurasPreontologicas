...
**Corpus inter-dominio (30 casos):** **4 strong con gate completo**: Energía, Deforestación, Kessler, Riesgo Biológico. **1 strong sin gate**: Microplásticos (EDI=0.78 pero CI inestable). **6 weak**: Postverdad, Urbanización, Fósforo, Wikipedia, Epidemiología, **Behavioral Dynamics (caso 30)**. **1 suggestive**: Finanzas (Salinización reclasificada por AU-4: CI 95 % `[-0.077, +0.083]` cruza cero + magnitud EDI=0.018 trivial). **5 trend**: Justicia, Starlink, Fuga de cerebros, Políticas (caso 13 reclasificado Weak→Trend tras re-ejecución iter 4 B-T2 con datos institucionales reales 2026-05-16, EDI=0.0821, p_perm=0.162), Movilidad (caso 11 confirmado Trend tras re-ejecución iter 4 B-T2 con datos TomTom reales 2026-05-16, EDI=0.0599, p_perm=0.922). **Bloque "null" subdividido (AU-9, actualizado 2026-05-16 con casos 01 Clima y 03 Contaminación)**: 7 nulls genuinos (Conciencia, Acidificación, Erosión, Acuíferos, IoT, Clima — reclasificado Trend→Null tras re-ejecución con datos reales IPCC-calibrados, EDI=-0.0007, p_perm=0.998 — y Contaminación — reclasificado Weak→Null tras re-ejecución iter 3 con datos World Bank PM2.5 reales, EDI=-0.0109, p_perm=0.616), 1 EDI negativo por sonda macro inadecuada (Paradigmas, EDI=-0.144), 1 señal rechazada por gate C1-C5 (Océanos). **3 controles de falsación correctamente rechazados**.
