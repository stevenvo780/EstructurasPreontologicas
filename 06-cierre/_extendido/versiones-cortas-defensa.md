...
**Corpus inter-dominio (30 casos):** **4 strong con gate completo**: Energía, Deforestación, Kessler, Riesgo Biológico. **1 strong sin gate**: Microplásticos (EDI=0.78 pero CI inestable). **8 weak**: Políticas, Postverdad, Urbanización, Fósforo, Wikipedia, Epidemiología, Movilidad, **Behavioral Dynamics (caso 30)**. **1 suggestive**: Finanzas (Salinización reclasificada por AU-4: CI 95 % `[-0.077, +0.083]` cruza cero + magnitud EDI=0.018 trivial). **3 trend**: Justicia, Starlink, Fuga de cerebros. **Bloque "null" subdividido (AU-9, actualizado 2026-05-16 con caso 01 Clima)**: 6 nulls genuinos (Conciencia, Acidificación, Erosión, Acuíferos, IoT, Clima — este último reclasificado Trend→Null tras re-ejecución con datos reales IPCC-calibrados, EDI=-0.0007, p_perm=0.998), 1 EDI negativo por sonda macro inadecuada (Paradigmas, EDI=-0.144), 2 señales rechazadas por gate C1-C5 (Contaminación, Océanos). **3 controles de falsación correctamente rechazados**.
