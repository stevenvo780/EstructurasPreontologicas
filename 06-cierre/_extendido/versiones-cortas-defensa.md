...
- **5 casos strong validados con gate completo:** Energía (EDI=0.65), Deforestación (0.60), Kessler (0.35), Riesgo Biológico (0.33), Urbanización (0.34, caso 18 promovido iter 5 B-T2 con datos World Bank reales 2026-05-17).
- **1 strong sin gate:** Microplásticos (0.78).
- **8 weak (significativos):** incluido caso 30 behavioral dynamics (0.26 v2 con sonda Fajen-Warren segundo orden) y caso 09 Finanzas promovido Suggestive→Weak iter 5 B-T2 con yfinance + FRED reales 2026-05-17 (EDI=0.10, CI estrictamente positivo).
...
**Corpus inter-dominio (30 casos):** **5 strong con gate completo**: Energía, Deforestación, Kessler, Riesgo Biológico, **Urbanización (caso 18 promovido Weak→Strong iter 5 B-T2 con datos World Bank SP.URB.TOTL.IN.ZS reales 2026-05-17: EDI=0.3366, p_perm=0.0, CI=[0.331, 0.347], `overall_pass=True`)**. **1 strong sin gate**: Microplásticos (EDI=0.78 pero CI inestable). **6 weak**: Postverdad, Fósforo, Wikipedia, Epidemiología, **Behavioral Dynamics (caso 30)**, **Finanzas (caso 09 promovido Suggestive→Weak iter 5 B-T2 con yfinance SPY + FRED reales 2026-05-17: EDI=0.1027, p_perm=0.0, CI=[0.1006, 0.1052] estrictamente positivo)**. **0 suggestive**: (Finanzas elevada a Weak; Salinización reclasificada por AU-4: CI 95 % `[-0.077, +0.083]` cruza cero + magnitud EDI=0.018 trivial). **5 trend**: Justicia, Starlink, Fuga de cerebros, Políticas (caso 13 reclasificado Weak→Trend tras re-ejecución iter 4 B-T2 con datos institucionales reales 2026-05-16, EDI=0.0821, p_perm=0.162), Movilidad (caso 11 confirmado Trend tras re-ejecución iter 4 B-T2 con datos TomTom reales 2026-05-16, EDI=0.0599, p_perm=0.922). **Nota iter 5 calibración bidireccional 2026-05-17:** la expansión B-T2 con datos reales produce tanto downgrades (01, 03, 11, 13) como upgrades (09 Finanzas, 18 Urbanización); el aparato modula en ambas direcciones, no solo degrada. **Bloque "null" subdividido (AU-9, actualizado 2026-05-16 con casos 01 Clima y 03 Contaminación)**: 7 nulls genuinos (Conciencia, Acidificación, Erosión, Acuíferos, IoT, Clima — reclasificado Trend→Null tras re-ejecución con datos reales IPCC-calibrados, EDI=-0.0007, p_perm=0.998 — y Contaminación — reclasificado Weak→Null tras re-ejecución iter 3 con datos World Bank PM2.5 reales, EDI=-0.0109, p_perm=0.616), 1 EDI negativo por sonda macro inadecuada (Paradigmas, EDI=-0.144), 1 señal rechazada por gate C1-C5 (Océanos). **3 controles de falsación correctamente rechazados**.
