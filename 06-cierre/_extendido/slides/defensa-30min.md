...
- 6 weak con disclosure (incluye Océanos iter 7 `valid=False`; Wikipedia retirado iter 8 → Null tras pre-registro firmado) · 1 suggestive (Justicia caso 10 iter 8 pre-registrado) · 3 trend · 7 null genuinos (incluye Wikipedia caso 15 iter 8 pre-registrado)
