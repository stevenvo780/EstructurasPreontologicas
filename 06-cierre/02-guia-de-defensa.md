...
**Justificación operativa (post-iter-8 B-T2 2026-05-17):** corpus inter-dominio con 6 strong con gate completo (Energía 0.65, Deforestación 0.60, Kessler 0.35, Riesgo Biológico 0.33, Urbanización 0.337, Microplásticos 0.806), 1 strong sin gate (Starlink 0.7575), 6 weak con disclosure (incluido Océanos iter 7 con `valid=False`; Wikipedia retirado iter 8 → Null tras pre-registro firmado con discrepancia honesta), 1 suggestive (Justicia caso 10 iter 8 reclasificado Trend→Suggestive tras pre-registro firmado con discrepancia honesta), 3 controles de falsación correctamente rechazados; corpus inter-escala con 7 strong en 7 escalas distintas (atómica, cuántica, bioquímica, celular oscilatoria, individual, astrofísica, astrofísica masiva). Hostile testing: 0/2000 falsos positivos del gate completo bajo random walk masivo (Wilson 95 % CI [0, 0.00191]). Discriminación pública contra quince rivales, incluidos Wolfram (piloto Rule 110 ejecutado, EDI = 0.55) e IIT (Tononi-Boly-Massimini-Koch 2016).
