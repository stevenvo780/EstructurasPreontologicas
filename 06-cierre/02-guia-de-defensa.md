...
> **Respuesta P7-bis iter 17 (cross-reference, BORRADOR-IA pendiente H-J5/H-J6/H-J7).** La nota epistemológica completa con la argumentación bidireccional B-T2, la objeción forking-paths (Gelman & Loken 2014 p. 460/464), el estatus lock-in-post-hoc de los 5 pre-registros previos (10, 15, 21, 23, 28) **y el cierre iter 17 por colapso post B-T2.1 GENUINOS (caso 24 Microplásticos colapsa de Strong robusto a Falsificación local; caso 04 Energía Strong→Weak validado por pre-registro genuino; caso 20 Kessler confirma Null; estado final 0 strong robustos puros sobrevivientes + 1 candidato pendiente 26 Starlink)** vive canónicamente en **cap 06-01 §1 (Reformulación honesta iter 17) y §5 Nota iter 17**. Resumen operativo para defensa: el aparato EDI opera como protocolo de admisión, mapa de cobertura y **ejemplo paradigmático de auto-corrección bajo pre-registro genuino** (modo técnico-ejecutado canonizado en cap 05-00 §3.bis); los 30 sintéticos calibran el aparato, los B-T2 con datos públicos son evidencia ontológica positiva acotada con sesgo de cobertura declarado, y los pre-registros B-T2.1 GENUINOS (firmados ANTES del fetch, primer bloque genuino del corpus) actúan como contra-falsadores del propio núcleo empírico canónico previo; **"ontología general multiescalar" queda como propuesta metodológicamente articulada con aparato auto-correctivo demostrado + 0 cierres empíricos definitivos al cierre del loop nocturno 2026-05-17; defensa por PROCESO (Lakatos progresivo: bug en cinturón protector detectado y arreglado, hechos excedentes novedosos predichos y corroborados, pre-registros B-T2.1 GENUINOS actuando contra el propio núcleo empírico), NO defensa por cifras empíricas acumuladas. El núcleo duro (irrealismo operativo + L1↔B↔L3↔S + dossier de 14 componentes + protocolo C1-C5 + EDI por intervención ablativa) sigue intacto.** Fallback honesto si el tribunal presiona sobre la asimetría sintético/real o sobre el colapso iter 17 del caso 24: declarar explícitamente que el colapso es virtud del aparato (auto-corrección bajo pre-registro genuino) y reposicionar el corpus como ejemplo metodológico, no como cartografía positiva confirmada. La firma H-J5/H-J6/H-J7 cubre la nota canónica en 06-01 y todas sus reapariciones (este P7-bis, resumen 00-05, correspondencia Ricardo).
