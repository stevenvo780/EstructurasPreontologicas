...
> **Respuesta P7-bis (cross-reference, BORRADOR-IA pendiente H-J5/H-J6/H-J7).** La nota epistemológica completa con la argumentación bidireccional B-T2, la objeción forking-paths (Gelman & Loken 2014 p. 460/464) y el estatus lock-in-post-hoc de los 5 pre-registros (10, 15, 21, 23, 28) vive canónicamente en **cap 06-01 §1**. Resumen operativo para defensa: el aparato EDI opera como protocolo de admisión y mapa de cobertura (modo técnico-ejecutado canonizado en cap 05-00 §3.bis); los 30 sintéticos calibran el aparato, los B-T2 con datos públicos son evidencia ontológica positiva directa con sesgo de cobertura declarado; "ontología general multiescalar" queda como propuesta operativamente articulada con demostración bidireccional parcial. Fallback honesto si el tribunal presiona sobre la asimetría sintético/real. La firma H-J5/H-J6/H-J7 cubre la nota canónica en 06-01 y todas sus reapariciones (este P7-bis, resumen 00-05, correspondencia Ricardo).
