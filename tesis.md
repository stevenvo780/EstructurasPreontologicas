...
Defendemos una ontología y epistemología generales integradoras, demostradas por cartografía multidominio sobre el **corpus EDI de 30 casos** que abarcan física, biología, economía, política, tecnología, cultura y conducta humana. La posición filosófica es **irrealismo operativo**: realismo estructural moderado + pluralismo epistemológico + anti-reificación operativa. La tesis sostiene siete afirmaciones articuladas:
...
**Demostración:** 30 casos del corpus EDI en física, biología, economía, política, tecnología, cultura y conducta humana, cada uno con dossier completo, datos públicos, ecuaciones ajustadas, predicciones cumplidas, intervenciones documentadas, controles de falsación. **5 strong** (4 con `overall_pass=True`), **8 weak** (incluido behavioral dynamics, caso 30), **2 suggestive**, **4 trend**, **8 null**, **3 controles de falsación correctamente rechazados**. Discriminación pública contra dualismo, materialismo de partículas, reduccionismo plano, emergentismo fuerte, constructivismo arbitrario, instrumentalismo puro, formalismo vacío, modelos internos / control óptimo, cognitivismo computacional, conductismo radical, enactivismo radical, realismo estructural informativo, mecanicismo multinivel sin filtro, **y Wolfram Physics Project**.
...
- **Concepto y dirección:** Jacob Agudelo, doctorando en filosofía de la ciencia, Universidad de Antioquia. La idea original del **irrealismo operativo de hiperobjetos**, la métrica **EDI**, el protocolo **C1-C5** y la posición filosófica completa son contribución de Jacob.
- **Técnica e ingeniería computacional:** Steven Vallejo Ortiz, líder técnico. Implementación del validador híbrido, infraestructura GPU, pipeline `./tesis`, dashboard web, formalización de la asimetría L1↔B↔L3↔S, articulación del dossier de anclaje en catorce componentes, integración del caso behavioral dynamics al corpus EDI bajo sonda Fajen-Warren de segundo orden.
...
2. **Coherencia con la distribución empírica del corpus:** los 30 casos generan distribución bimodal natural. Gap entre 0.297 y 0.333 sugiere discontinuidad real, no partición artificial.
...
| 30 Behavioral dynamics (Fajen-Warren) | **0.262** | 0.044 |
...
## 13. Caso 30 del corpus: behavioral dynamics

El caso 30 incorpora behavioral dynamics al corpus EDI bajo metodología unificada:

**Sistema:** par dinámico acoplado agente humano – entorno con tarea de locomoción dirigida (Fajen y Warren 2003).

**Sonda ODE (`behavioral_attractor`, segundo orden):** φ̈ = −b φ̇ − k_g(φ−ψ_g)(e^(−c1 d_g)+c2), con parámetros publicados b=3.25, k_g=7.50, c1=0.40, c2=0.40.

**Modelo ABM (micro):** retícula 40×40 con biomecánica realista, difusión espacial y ruido motor.

**Datos:** serie sintética de 121 puntos generada con la ecuación completa de segundo orden de Fajen-Warren, evitando circularidad ABM≡ODE (LoE=2; elevación a LoE=4 con datos humanos reales como trabajo posterior).

**Resultado empírico:** EDI=0.262, p=0.044 significativo, bootstrap CI=[0.249, 0.280]. Verificación con perfil agresivo (n_perm=2999, n_boot=1500): EDI=0.263, idéntico, robusto. Behavioral dynamics queda clasificado en **Nivel 3 (weak)** dentro del corpus, comparable a epidemiología y movilidad. La elevación a Nivel 4 (strong) requiere extensión metodológica (datos humanos reales, resolución temporal alta, multi-sonda) documentada como deuda residual.
...
- aplicaciones multidominio (30 casos del corpus EDI): capítulo 09 (simulaciones EDI);
...
El manuscrito presenta la cartografía multidominio del corpus EDI de 30 casos, la discriminación pública contra catorce rivales (incluido Wolfram), las condiciones de fracaso falsables y la deuda residual nombrada como un solo cuerpo argumental. Lo que separa esta tesis de un manifiesto es el compromiso explícito con los términos de su propio fracaso posible. Lo que la separa de una afirmación retórica es la predicción discriminante verificable bajo intervención.
