...
Aplicamos el aparato Effective Dependence Index (EDI) a 02 — conciencia para
...
tests adversariales) reportamos EDI = -0.11646132488773708, p_block = 0.010666666666666666, CI 95% = [-0.17296071213955544, -0.06170601129643648].
La sonda secundaria con motivación teórica independiente (fisica_estadistica) produce
|Δ EDI| = 0.8832164369144504. Pre-registro criptográfico bajo hash cbd902b41bebd3b8
(commit a24f6dd14049). Datos: Sintético derivado de literatura EEG.
...
**Fuente:** Sintético derivado de literatura EEG
...
**Sonda secundaria:** fokker_planck_drift_diffusion

**Motivación teórica:** fisica_estadistica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `cbd902b41bebd3b8`
...
- **EDI puntual:** -0.11646132488773708
- **p-value naive:** 0.923923923923924
- **p-value block bootstrap (V5.1):** 0.010666666666666666
- **CI bootstrap 95%:** [-0.17296071213955544, -0.06170601129643648]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.8832164369144504
...
- Sin ground truth de consciencia fenoménica
...
**Hash del setup pre-ejecución:** `cbd902b41bebd3b8...`
...
```bash
python3 scripts/freeze_setup.py --verify 02_caso_conciencia
```
