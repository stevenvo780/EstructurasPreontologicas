...
Aplicamos el aparato Effective Dependence Index (EDI) a 06 — falsacion exogeneidad para
...
tests adversariales) reportamos EDI = 0.05505918915717987, p_block = 0.3873333333333333, CI 95% = [0.03438815097659429, 0.07438687161843083].
La sonda secundaria con motivación teórica independiente (control_de_falsabilidad) produce
|Δ EDI| = 1.0547864559982807. Pre-registro criptográfico bajo hash 9290d18a53e30113
(commit a24f6dd14049). Datos: Random walk sintético.
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `9290d18a53e30113`
...
- **EDI puntual:** 0.05505918915717987
- **p-value naive:** 1.0
- **p-value block bootstrap (V5.1):** 0.3873333333333333
- **CI bootstrap 95%:** [0.03438815097659429, 0.07438687161843083]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.0547864559982807
...
- Control de falsación, no caso real
...
**Hash del setup pre-ejecución:** `9290d18a53e30113...`
...
```bash
python3 scripts/freeze_setup.py --verify 06_caso_falsacion_exogeneidad
```
