...
> Este archivo amplía la discusión sintética que el manuscrito principal mantiene en `04-debates/01 §15` y la matriz tabular en `04-debates/03 §13`. Aquí va el desarrollo argumentativo extenso, citas paginadas, micro-tabla tesis/rival completa y discusión de modos de confusión. La web lo carga bajo demanda; el lector continuo del manuscrito ve sólo la versión sintética.
