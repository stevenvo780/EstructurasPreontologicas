...
Aplicamos el aparato Effective Dependence Index (EDI) a 14 — postverdad para
...
tests adversariales) reportamos EDI = 0.24284958859933714, p_block = 0.0003333333333333333, CI 95% = [0.16858823764150366, 0.35710048831804236].
La sonda secundaria con motivación teórica independiente (marketing_quantitativo) produce
|Δ EDI| = 0.23252823185062624. Pre-registro criptográfico bajo hash 141bc5aac568c2c6
(commit a24f6dd14049). Datos: Google Trends + Wikipedia stats.
...
**Fuente:** Google Trends + Wikipedia stats
...
**Sonda secundaria:** bass_diffusion

**Motivación teórica:** marketing_quantitativo
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `141bc5aac568c2c6`
...
- **EDI puntual:** 0.24284958859933714
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.16858823764150366, 0.35710048831804236]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.23252823185062624
...
**Hash del setup pre-ejecución:** `141bc5aac568c2c6...`
...
```bash
python3 scripts/freeze_setup.py --verify 14_caso_postverdad
```
