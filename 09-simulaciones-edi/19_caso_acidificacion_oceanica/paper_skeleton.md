...
Aplicamos el aparato Effective Dependence Index (EDI) a 19 — acidificacion oceanica para
...
tests adversariales) reportamos EDI = -0.0001909971007845106, p_block = 0.5496666666666666, CI 95% = [-0.0009419554604128565, -5.923327890545144e-06].
La sonda secundaria con motivación teórica independiente (termodinamica_disolucion) produce
|Δ EDI| = 0.6775969393528073. Pre-registro criptográfico bajo hash 2e3020640031ffc3
(commit a24f6dd14049). Datos: PMEL/NOAA pH proxy.
...
**Sonda secundaria:** henry_law_solubility

**Motivación teórica:** termodinamica_disolucion
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `2e3020640031ffc3`
...
- **EDI puntual:** -0.0001909971007845106
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.5496666666666666
- **CI bootstrap 95%:** [-0.0009419554604128565, -5.923327890545144e-06]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.6775969393528073
...
**Hash del setup pre-ejecución:** `2e3020640031ffc3...`
...
```bash
python3 scripts/freeze_setup.py --verify 19_caso_acidificacion_oceanica
```
