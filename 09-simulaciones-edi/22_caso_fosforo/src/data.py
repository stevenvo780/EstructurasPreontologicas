...
def fetch_fertilizer_consumption(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Fertilizer consumption (kg per hectare) del World Bank."""
