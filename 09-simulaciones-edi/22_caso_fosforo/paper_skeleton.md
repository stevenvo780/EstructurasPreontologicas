...
Aplicamos el aparato Effective Dependence Index (EDI) a 22 — fosforo para
...
tests adversariales) reportamos EDI = 0.19240058742600652, p_block = 0.0003333333333333333, CI 95% = [-0.22144118470606053, 0.5502177656704227].
La sonda secundaria con motivación teórica independiente (limnologia_simple) produce
|Δ EDI| = 0.3955215412494524. Pre-registro criptográfico bajo hash d570544204fffe43
(commit a24f6dd14049). Datos: World Bank fertilizer use.
...
**Fuente:** World Bank fertilizer use
...
**Sonda secundaria:** logistic_phosphorus

**Motivación teórica:** limnologia_simple
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `d570544204fffe43`
...
- **EDI puntual:** 0.19240058742600652
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [-0.22144118470606053, 0.5502177656704227]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.3955215412494524
...
**Hash del setup pre-ejecución:** `d570544204fffe43...`
...
```bash
python3 scripts/freeze_setup.py --verify 22_caso_fosforo
```
