# Narrativa V5.5 — 42_caso_histeresis_institucional

## Conexión con la tesis central

**Bloque narrativo:** B — Panel agregado / replicación espacial

**Función específica del caso:**

Verifica invariantes ontológicos a través de replicación inter-unidad (países, regiones). El panel multiplica n efectivo y refuerza la afirmación de generalidad.
