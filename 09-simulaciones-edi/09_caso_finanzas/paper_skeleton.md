...
Aplicamos el aparato Effective Dependence Index (EDI) a 09 — finanzas para
...
tests adversariales) reportamos EDI = 0.08125725845167885, p_block = 0.010333333333333333, CI 95% = [0.07943019708482985, 0.08341434939049598].
La sonda secundaria con motivación teórica independiente (matematica_financiera) produce
|Δ EDI| = 1.0809920866999214. Pre-registro criptográfico bajo hash 7b586f71a8ef2040
(commit a24f6dd14049). Datos: Yahoo Finance.
...
**Sonda secundaria:** heston_stochastic_volatility

**Motivación teórica:** matematica_financiera
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `7b586f71a8ef2040`
...
- **EDI puntual:** 0.08125725845167885
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.010333333333333333
- **CI bootstrap 95%:** [0.07943019708482985, 0.08341434939049598]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.0809920866999214
...
**Hash del setup pre-ejecución:** `7b586f71a8ef2040...`
...
```bash
python3 scripts/freeze_setup.py --verify 09_caso_finanzas
```
