...
Aplicamos el aparato Effective Dependence Index (EDI) a 26 — starlink para
...
tests adversariales) reportamos EDI = 0.6891705119737255, p_block = 0.001, CI 95% = [0.6891705119737255, 0.6891705119737255].
La sonda secundaria con motivación teórica independiente (modelos_demograficos) produce
|Δ EDI| = 1.6890807989386065. Pre-registro criptográfico bajo hash 6080dd3587de3a96
(commit a24f6dd14049). Datos: CelesTrak.
...
**Sonda secundaria:** exponential_growth

**Motivación teórica:** modelos_demograficos
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `6080dd3587de3a96`
...
- **EDI puntual:** 0.6891705119737255
- **p-value naive:** 1.0
- **p-value block bootstrap (V5.1):** 0.001
- **CI bootstrap 95%:** [0.6891705119737255, 0.6891705119737255]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.6890807989386065
...
**Hash del setup pre-ejecución:** `6080dd3587de3a96...`
...
```bash
python3 scripts/freeze_setup.py --verify 26_caso_starlink
```
