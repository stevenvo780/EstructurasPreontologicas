...
Aplicamos el aparato Effective Dependence Index (EDI) a 08 — falsacion observabilidad para
...
tests adversariales) reportamos EDI = -1.0, p_block = 0.002, CI 95% = [-2.5032289642808547, -1.7970760543243096].
La sonda secundaria con motivación teórica independiente (control_de_falsabilidad) produce
|Δ EDI| = 0.0. Pre-registro criptográfico bajo hash cc4240f852cc5c33
(commit a24f6dd14049). Datos: Sistema con variable latente sintético.
...
**Fuente:** Sistema con variable latente sintético
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `cc4240f852cc5c33`
...
- **EDI puntual:** -1.0
- **p-value naive:** 1.0
- **p-value block bootstrap (V5.1):** 0.002
- **CI bootstrap 95%:** [-2.5032289642808547, -1.7970760543243096]
...
**Hash del setup pre-ejecución:** `cc4240f852cc5c33...`
...
```bash
python3 scripts/freeze_setup.py --verify 08_caso_falsacion_observabilidad
```
