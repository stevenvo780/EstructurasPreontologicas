...
Aplicamos el aparato Effective Dependence Index (EDI) a 03 — contaminacion para
...
tests adversariales) reportamos EDI = -0.003799866103022012, p_block = 0.21933333333333332, CI 95% = [-0.020946031117234108, 0.011642433647188085].
La sonda secundaria con motivación teórica independiente (epidemiologia_clasica) produce
|Δ EDI| = 0.4767105830363731. Pre-registro criptográfico bajo hash 76616e41d9d8a961
(commit a24f6dd14049). Datos: AQICN.
...
**Sonda secundaria:** sir_compartmental_pollution

**Motivación teórica:** epidemiologia_clasica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `76616e41d9d8a961`
...
- **EDI puntual:** -0.003799866103022012
- **p-value naive:** 0.8698698698698699
- **p-value block bootstrap (V5.1):** 0.21933333333333332
- **CI bootstrap 95%:** [-0.020946031117234108, 0.011642433647188085]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.4767105830363731
...
**Hash del setup pre-ejecución:** `76616e41d9d8a961...`
...
```bash
python3 scripts/freeze_setup.py --verify 03_caso_contaminacion
```
