...
Aplicamos el aparato Effective Dependence Index (EDI) a 15 — wikipedia para
...
tests adversariales) reportamos EDI = 0.19162977697124867, p_block = 0.0003333333333333333, CI 95% = [0.12467811339194194, 0.5135395847963541].
La sonda secundaria con motivación teórica independiente (demografia_envejecimiento) produce
|Δ EDI| = 1.0649740974644284. Pre-registro criptográfico bajo hash 40a0fb0f9e9c7c7c
(commit a24f6dd14049). Datos: Wikimedia Statistics.
...
**Sonda secundaria:** gompertz_growth

**Motivación teórica:** demografia_envejecimiento
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `40a0fb0f9e9c7c7c`
...
- **EDI puntual:** 0.19162977697124867
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.12467811339194194, 0.5135395847963541]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.0649740974644284
...
**Hash del setup pre-ejecución:** `40a0fb0f9e9c7c7c...`
...
```bash
python3 scripts/freeze_setup.py --verify 15_caso_wikipedia
```
