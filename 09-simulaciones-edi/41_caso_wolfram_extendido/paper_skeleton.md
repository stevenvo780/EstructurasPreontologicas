...
Aplicamos el aparato Effective Dependence Index (EDI) a 41 — wolfram extendido para
...
tests adversariales) reportamos EDI = -0.2750861300597808, p_block = 1.0, CI 95% = [-0.38718181971983273, -0.16701499423842847].
La sonda secundaria con motivación teórica independiente (?) produce
|Δ EDI| = ?. Pre-registro criptográfico bajo hash b3a5f578c8bcb1fe
(commit a05767f0554b). Datos: Sintético — autómatas celulares Rule 30/90/110/184.
...
**Fuente:** Sintético — autómatas celulares Rule 30/90/110/184
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `b3a5f578c8bcb1fe`
...
- **EDI puntual:** -0.2750861300597808
- **p-value naive:** 0.5735
- **p-value block bootstrap (V5.1):** 1.0
- **CI bootstrap 95%:** [-0.38718181971983273, -0.16701499423842847]
...
- Datos del autómata reales pero sintéticos; sirve a discriminación contra Wolfram
...
**Hash del setup pre-ejecución:** `b3a5f578c8bcb1fe...`
...
```bash
python3 scripts/freeze_setup.py --verify 41_caso_wolfram_extendido
```
