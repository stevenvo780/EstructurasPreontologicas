...
Aplicamos el aparato Effective Dependence Index (EDI) a 11 — movilidad para
...
tests adversariales) reportamos EDI = 0.12828980793063793, p_block = 0.0003333333333333333, CI 95% = [-0.07292696330519564, 0.2520634097602745].
La sonda secundaria con motivación teórica independiente (fisica_gravitacional_aplicada) produce
|Δ EDI| = 1.1280382109294294. Pre-registro criptográfico bajo hash 5b9cc18b44081f1a
...
**Sonda secundaria:** gravity_model

**Motivación teórica:** fisica_gravitacional_aplicada
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `5b9cc18b44081f1a`
...
- **EDI puntual:** 0.12828980793063793
- **p-value naive:** 0.002002002002002002
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [-0.07292696330519564, 0.2520634097602745]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.1280382109294294
...
**Hash del setup pre-ejecución:** `5b9cc18b44081f1a...`
...
```bash
python3 scripts/freeze_setup.py --verify 11_caso_movilidad
```
