...
Aplicamos el aparato Effective Dependence Index (EDI) a 10 — justicia para
...
tests adversariales) reportamos EDI = 0.22744325283615935, p_block = 1.0, CI 95% = [0.17116963798442225, 0.3296476906405439].
La sonda secundaria con motivación teórica independiente (control_lineal_clasico) produce
|Δ EDI| = 0.1308900568257544. Pre-registro criptográfico bajo hash 221d698d11a6755f
...
**Sonda secundaria:** linear_relaxation_justice
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `221d698d11a6755f`
...
- **EDI puntual:** 0.22744325283615935
- **p-value naive:** 0.4774774774774775
- **p-value block bootstrap (V5.1):** 1.0
- **CI bootstrap 95%:** [0.17116963798442225, 0.3296476906405439]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.1308900568257544
...
**Hash del setup pre-ejecución:** `221d698d11a6755f...`
...
```bash
python3 scripts/freeze_setup.py --verify 10_caso_justicia
```
