...
Aplicamos el aparato Effective Dependence Index (EDI) a 12 — paradigmas para
...
tests adversariales) reportamos EDI = -0.006047380762526654, p_block = 0.619, CI 95% = [-0.014077678022930026, -0.004277641039442601].
La sonda secundaria con motivación teórica independiente (sincronizacion_no_lineal) produce
|Δ EDI| = 0.9936622492195745. Pre-registro criptográfico bajo hash 38efc10f8f29d18e
(commit a24f6dd14049). Datos: OWID educación.
...
**Sonda secundaria:** kuramoto_synchronization

**Motivación teórica:** sincronizacion_no_lineal
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `38efc10f8f29d18e`
...
- **EDI puntual:** -0.006047380762526654
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.619
- **CI bootstrap 95%:** [-0.014077678022930026, -0.004277641039442601]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.9936622492195745
...
**Hash del setup pre-ejecución:** `38efc10f8f29d18e...`
...
```bash
python3 scripts/freeze_setup.py --verify 12_caso_paradigmas
```
