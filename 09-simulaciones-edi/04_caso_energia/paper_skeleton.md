...
Aplicamos el aparato Effective Dependence Index (EDI) a 04 — energia para
...
tests adversariales) reportamos EDI = 0.650265837204689, p_block = 0.0003333333333333333, CI 95% = [0.44473706866002977, 0.788547187130125].
La sonda secundaria con motivación teórica independiente (termodinamica_estadistica) produce
|Δ EDI| = 0.6855957747557173. Pre-registro criptográfico bajo hash 354d8c0264940f46
(commit a24f6dd14049). Datos: Open Power Systems Data.
...
**Fuente:** Open Power Systems Data
...
**Sonda secundaria:** maxwell_boltzmann

**Motivación teórica:** termodinamica_estadistica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `354d8c0264940f46`
...
- **EDI puntual:** 0.650265837204689
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.44473706866002977, 0.788547187130125]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.6855957747557173
...
**Hash del setup pre-ejecución:** `354d8c0264940f46...`
