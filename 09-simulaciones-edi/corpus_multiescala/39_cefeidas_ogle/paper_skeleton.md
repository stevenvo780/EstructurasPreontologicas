...
Aplicamos el aparato Effective Dependence Index (EDI) a 39 cefeidas ogle para
...
tests adversariales) reportamos EDI = 0.9162290686317869, p_block = 0.0003333333333333333, CI 95% = [0.9002927973394179, 0.9306754589839815].
La sonda secundaria con motivación teórica independiente (evolucion_estelar) produce
|Δ EDI| = 1.2457420854030654. Pre-registro criptográfico bajo hash 72155ff90e82ba9a
(commit a24f6dd14049). Datos: Sintético Leavitt P-L — parámetros OGLE LMC.
...
**Fuente:** Sintético Leavitt P-L — parámetros OGLE LMC

**URL:** https://ogle.astrouw.edu.pl
...
**Sonda secundaria:** reimers_mass_loss

**Motivación teórica:** evolucion_estelar
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `72155ff90e82ba9a`
...
- **EDI puntual:** 0.9162290686317869
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.9002927973394179, 0.9306754589839815]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.2457420854030654
...
- Leavitt, H. S. (1908). *Annals Harvard Coll. Obs.* 60.
...
**Hash del setup pre-ejecución:** `72155ff90e82ba9a...`
...
```bash
python3 scripts/freeze_setup.py --verify 39_cefeidas_ogle
```
