...
Aplicamos el aparato Effective Dependence Index (EDI) a 34 michaelis menten para
...
tests adversariales) reportamos EDI = 0.4580474281524688, p_block = 0.0003333333333333333, CI 95% = [0.33388872384377416, 0.5687708613419207].
La sonda secundaria con motivación teórica independiente (cooperatividad_enzimatica) produce
|Δ EDI| = 0.1674642778427302. Pre-registro criptográfico bajo hash 7b06722af002b03a
(commit a24f6dd14049). Datos: Sintético MM — parámetros BRENDA.
...
**Fuente:** Sintético MM — parámetros BRENDA
...
**Sonda secundaria:** hill_cooperative

**Motivación teórica:** cooperatividad_enzimatica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `7b06722af002b03a`
...
- **EDI puntual:** 0.4580474281524688
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.33388872384377416, 0.5687708613419207]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.1674642778427302
...
**Hash del setup pre-ejecución:** `7b06722af002b03a...`
...
```bash
python3 scripts/freeze_setup.py --verify 34_michaelis_menten
```
