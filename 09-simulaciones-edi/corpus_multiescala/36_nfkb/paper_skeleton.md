...
Aplicamos el aparato Effective Dependence Index (EDI) a 36 nfkb para
...
tests adversariales) reportamos EDI = 0.5873739314271895, p_block = 0.0003333333333333333, CI 95% = [0.5842874947984737, 0.5891523031787347].
La sonda secundaria con motivación teórica independiente (redes_oscilatorias) produce
|Δ EDI| = 1.5872548373952302. Pre-registro criptográfico bajo hash 31096b2aad3155b4
(commit a24f6dd14049). Datos: Sintético Hoffmann — parámetros literatura.
...
**Fuente:** Sintético Hoffmann — parámetros literatura
...
**Sonda secundaria:** goldbeter_nfkb

**Motivación teórica:** redes_oscilatorias
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `31096b2aad3155b4`
...
- **EDI puntual:** 0.5873739314271895
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.5842874947984737, 0.5891523031787347]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.5872548373952302
...
- Hoffmann, A. et al. (2002). *Science* 298(5596).
...
**Hash del setup pre-ejecución:** `31096b2aad3155b4...`
...
```bash
python3 scripts/freeze_setup.py --verify 36_nfkb
```
