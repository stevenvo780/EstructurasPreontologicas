...
Aplicamos el aparato Effective Dependence Index (EDI) a 35 ciclo celular para
...
tests adversariales) reportamos EDI = 0.1306799800346662, p_block = 0.003, CI 95% = [0.10892306370480587, 0.14785287170888892].
La sonda secundaria con motivación teórica independiente (oscilaciones_circadianas) produce
|Δ EDI| = 0.8932570973442101. Pre-registro criptográfico bajo hash 383da90b293698a2
(commit a24f6dd14049). Datos: Sintético Tyson-Novak.
...
**Sonda secundaria:** goldbeter_oscillator

**Motivación teórica:** oscilaciones_circadianas
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `383da90b293698a2`
...
- **EDI puntual:** 0.1306799800346662
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.003
- **CI bootstrap 95%:** [0.10892306370480587, 0.14785287170888892]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.8932570973442101
...
- Tyson, J. J. y Novak, B. (2001). *J. Theor. Biol.* 210(2).
...
**Hash del setup pre-ejecución:** `383da90b293698a2...`
...
```bash
python3 scripts/freeze_setup.py --verify 35_ciclo_celular
```
