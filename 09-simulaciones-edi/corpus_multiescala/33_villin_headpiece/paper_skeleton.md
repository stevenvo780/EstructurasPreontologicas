...
Aplicamos el aparato Effective Dependence Index (EDI) a 33 villin headpiece para
...
tests adversariales) reportamos EDI = 0.0, p_block = 0.5113333333333333, CI 95% = [-2.220446049250313e-16, 0.0].
La sonda secundaria con motivación teórica independiente (fisica_de_transiciones) produce
|Δ EDI| = 0.13338488340421945. Pre-registro criptográfico bajo hash ee5ec4e212a9ff1e
(commit a24f6dd14049). Datos: Sintético MSM 2-estados — Anton 2 Shaw 2010.
...
**Fuente:** Sintético MSM 2-estados — Anton 2 Shaw 2010
...
**Sonda secundaria:** kramers_transition_state

**Motivación teórica:** fisica_de_transiciones
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `ee5ec4e212a9ff1e`
...
- **EDI puntual:** 0.0
- **p-value naive:** 0.8258258258258259
- **p-value block bootstrap (V5.1):** 0.5113333333333333
- **CI bootstrap 95%:** [-2.220446049250313e-16, 0.0]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.13338488340421945
...
- Sonda equilibrio inadecuada (declarado)
...
- Shaw, D. E. et al. (2010). *Science* 330(6002).
...
**Hash del setup pre-ejecución:** `ee5ec4e212a9ff1e...`
...
```bash
python3 scripts/freeze_setup.py --verify 33_villin_headpiece
```
