...
Aplicamos el aparato Effective Dependence Index (EDI) a 18 — urbanizacion para
...
tests adversariales) reportamos EDI = 0.23583251166779556, p_block = 0.0003333333333333333, CI 95% = [0.2314799472001111, 0.2428897741361156].
La sonda secundaria con motivación teórica independiente (demografia_no_simetrica) produce
|Δ EDI| = 1.2356119541359063. Pre-registro criptográfico bajo hash 492791cc95d13fb1
(commit a24f6dd14049). Datos: World Bank Open Data urban.
...
**Fuente:** World Bank Open Data urban
...
**Sonda secundaria:** gompertz_urban

**Motivación teórica:** demografia_no_simetrica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `492791cc95d13fb1`
...
- **EDI puntual:** 0.23583251166779556
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.2314799472001111, 0.2428897741361156]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.2356119541359063
...
**Hash del setup pre-ejecución:** `492791cc95d13fb1...`
...
```bash
python3 scripts/freeze_setup.py --verify 18_caso_urbanizacion
```
