...
Aplicamos el aparato Effective Dependence Index (EDI) a 20 — kessler para
...
tests adversariales) reportamos EDI = 0.35269595151500943, p_block = 0.0003333333333333333, CI 95% = [0.3082661981918899, 0.5197667268067611].
La sonda secundaria con motivación teórica independiente (ecologia_clasica) produce
|Δ EDI| = 0.24548253036312567. Pre-registro criptográfico bajo hash 29e050ac20a2321e
(commit a24f6dd14049). Datos: CelesTrak debris.
...
**Sonda secundaria:** lotka_volterra

**Motivación teórica:** ecologia_clasica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `29e050ac20a2321e`
...
- **EDI puntual:** 0.35269595151500943
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.3082661981918899, 0.5197667268067611]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.24548253036312567
...
**Hash del setup pre-ejecución:** `29e050ac20a2321e...`
...
```bash
python3 scripts/freeze_setup.py --verify 20_caso_kessler
```
