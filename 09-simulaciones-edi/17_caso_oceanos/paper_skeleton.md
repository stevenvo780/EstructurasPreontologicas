...
Aplicamos el aparato Effective Dependence Index (EDI) a 17 — oceanos para
...
tests adversariales) reportamos EDI = -0.015399742732341487, p_block = 1.0, CI 95% = [-0.030803182927886367, -0.010939860351576895].
La sonda secundaria con motivación teórica independiente (oceanografia_clasica) produce
|Δ EDI| = 0.026271066638134027. Pre-registro criptográfico bajo hash 6ec81b35971b5738
(commit a24f6dd14049). Datos: WMO/PMEL.
...
**Sonda secundaria:** stommel_thermohaline

**Motivación teórica:** oceanografia_clasica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `6ec81b35971b5738`
...
- **EDI puntual:** -0.015399742732341487
- **p-value naive:** 1.0
- **p-value block bootstrap (V5.1):** 1.0
- **CI bootstrap 95%:** [-0.030803182927886367, -0.010939860351576895]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.026271066638134027
...
**Hash del setup pre-ejecución:** `6ec81b35971b5738...`
...
```bash
python3 scripts/freeze_setup.py --verify 17_caso_oceanos
```
