...
Aplicamos el aparato Effective Dependence Index (EDI) a 28 — fuga cerebros para
...
tests adversariales) reportamos EDI = 0.024881669387389924, p_block = 0.001, CI 95% = [-0.15369319068090054, 0.18748469130468035].
La sonda secundaria con motivación teórica independiente (fisica_aplicada_a_migracion) produce
|Δ EDI| = 1.0246002262540665. Pre-registro criptográfico bajo hash b668b62cd2ac2266
(commit a24f6dd14049). Datos: World Bank net migration tertiary.
...
**Fuente:** World Bank net migration tertiary
...
**Sonda secundaria:** gravity_brain_drain

**Motivación teórica:** fisica_aplicada_a_migracion
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `b668b62cd2ac2266`
...
- **EDI puntual:** 0.024881669387389924
- **p-value naive:** 0.9974997499749975
- **p-value block bootstrap (V5.1):** 0.001
- **CI bootstrap 95%:** [-0.15369319068090054, 0.18748469130468035]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 1.0246002262540665
...
**Hash del setup pre-ejecución:** `b668b62cd2ac2266...`
...
```bash
python3 scripts/freeze_setup.py --verify 28_caso_fuga_cerebros
```
