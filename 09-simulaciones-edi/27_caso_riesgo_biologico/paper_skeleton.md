...
Aplicamos el aparato Effective Dependence Index (EDI) a 27 — riesgo biologico para
...
tests adversariales) reportamos EDI = 0.3325786296723718, p_block = 0.0003333333333333333, CI 95% = [-0.19753129125045035, 0.6484399166069068].
La sonda secundaria con motivación teórica independiente (topologia_catastrofes) produce
|Δ EDI| = 0.45610029236580857. Pre-registro criptográfico bajo hash 4f051c29214dd8de
(commit a24f6dd14049). Datos: World Bank mortality + WHO.
...
**Fuente:** World Bank mortality + WHO
...
**Sonda secundaria:** zeeman_catastrophe

**Motivación teórica:** topologia_catastrofes
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `4f051c29214dd8de`
...
- **EDI puntual:** 0.3325786296723718
- **p-value naive:** 0.0022002200220022
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [-0.19753129125045035, 0.6484399166069068]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.45610029236580857
...
**Hash del setup pre-ejecución:** `4f051c29214dd8de...`
...
```bash
python3 scripts/freeze_setup.py --verify 27_caso_riesgo_biologico
```
