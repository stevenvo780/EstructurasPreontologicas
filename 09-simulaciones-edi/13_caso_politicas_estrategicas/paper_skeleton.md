...
Aplicamos el aparato Effective Dependence Index (EDI) a 13 — politicas estrategicas para
...
tests adversariales) reportamos EDI = 0.2972459599653249, p_block = 0.001, CI 95% = [0.2570784148887326, 0.32805189212692853].
La sonda secundaria con motivación teórica independiente (control_lineal_clasico) produce
|Δ EDI| = 0.09154928389879169. Pre-registro criptográfico bajo hash bf1c78a68688ef51
(commit a24f6dd14049). Datos: World Bank Open Data.
...
**Sonda secundaria:** linear_relaxation_policy

**Motivación teórica:** control_lineal_clasico
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `bf1c78a68688ef51`
...
- **EDI puntual:** 0.2972459599653249
- **p-value naive:** 0.0015001500150015
- **p-value block bootstrap (V5.1):** 0.001
- **CI bootstrap 95%:** [0.2570784148887326, 0.32805189212692853]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.09154928389879169
...
**Hash del setup pre-ejecución:** `bf1c78a68688ef51...`
...
```bash
python3 scripts/freeze_setup.py --verify 13_caso_politicas_estrategicas
```
