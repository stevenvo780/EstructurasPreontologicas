...
Aplicamos el aparato Effective Dependence Index (EDI) a 23 — erosion dialectica para
...
tests adversariales) reportamos EDI = -1.0, p_block = 0.0003333333333333333, CI 95% = [-3.0882520193888854, -0.6847569321727853].
La sonda secundaria con motivación teórica independiente (control_caso_piloto) produce
|Δ EDI| = 0.0. Pre-registro criptográfico bajo hash 50ebe8ef770bc5d3
(commit a24f6dd14049). Datos: Sintético de proxy literario.
...
**Fuente:** Sintético de proxy literario
...
**Sonda secundaria:** random_walk_dialectical

**Motivación teórica:** control_caso_piloto
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `50ebe8ef770bc5d3`
...
- **CI bootstrap 95%:** [-3.0882520193888854, -0.6847569321727853]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.0
...
- Erosión dialéctica no tiene observable directo; piloto conceptual
...
**Hash del setup pre-ejecución:** `50ebe8ef770bc5d3...`
...
```bash
python3 scripts/freeze_setup.py --verify 23_caso_erosion_dialectica
```
