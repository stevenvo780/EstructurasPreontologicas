...
Aplicamos el aparato Effective Dependence Index (EDI) a 25 — acuiferos para
...
tests adversariales) reportamos EDI = -0.14615334806176566, p_block = 0.001, CI 95% = [-0.16487351602805944, -0.12397347332429165].
La sonda secundaria con motivación teórica independiente (hidrogeologia_clasica) produce
|Δ EDI| = 0.033023422173499295. Pre-registro criptográfico bajo hash a4ad9b7cf06ff39e
(commit a24f6dd14049). Datos: USGS GRACE proxy.
...
**Sonda secundaria:** darcy_groundwater

**Motivación teórica:** hidrogeologia_clasica
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `a4ad9b7cf06ff39e`
...
- **EDI puntual:** -0.14615334806176566
- **p-value naive:** 1.0
- **p-value block bootstrap (V5.1):** 0.001
- **CI bootstrap 95%:** [-0.16487351602805944, -0.12397347332429165]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.033023422173499295
...
**Hash del setup pre-ejecución:** `a4ad9b7cf06ff39e...`
...
```bash
python3 scripts/freeze_setup.py --verify 25_caso_acuiferos
```
