...
Aplicamos el aparato Effective Dependence Index (EDI) a 16 — deforestacion para
...
tests adversariales) reportamos EDI = 0.5802201286883273, p_block = 0.0003333333333333333, CI 95% = [0.4227012521349511, 0.7091746761435175].
La sonda secundaria con motivación teórica independiente (matematica_reactiva) produce
|Δ EDI| = 0.4630469819254861. Pre-registro criptográfico bajo hash 66096f5c23c1cc1f
(commit a24f6dd14049). Datos: World Bank Open Data forest area.
...
**Fuente:** World Bank Open Data forest area
...
**Motivación teórica:** matematica_reactiva
...
**Pre-registro:** SETUP_HASH.json con aggregate_hash = `66096f5c23c1cc1f`
...
- **EDI puntual:** 0.5802201286883273
- **p-value naive:** 0.0
- **p-value block bootstrap (V5.1):** 0.0003333333333333333
- **CI bootstrap 95%:** [0.4227012521349511, 0.7091746761435175]

### 3.2. Convergencia con sonda secundaria

|Δ EDI| inter-paradigma = 0.4630469819254861
...
**Hash del setup pre-ejecución:** `66096f5c23c1cc1f...`
...
```bash
python3 scripts/freeze_setup.py --verify 16_caso_deforestacion
```
